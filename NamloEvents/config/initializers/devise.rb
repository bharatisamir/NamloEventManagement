...
Devise.setup do |config|
  ...
  # config.secret_key = '7f79214db828ae5f55eedd1753e1c736ca5631e859c5e8e50473119ef9abbfc3014165e5fc41745abd41e5c1124b5275f59dc292c4569e1d6097730d9a71467d'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  #config.mailer_sender = 'namloevent@gmail.com'
  config.mailer_sender = 'namloeventmanagement@gmail.com'
  #config.mailer_sender = 'postmaster@sandbox8739a9af2cf245088bcfad504cd5eaec.mailgun.org'
  ...
  # config.pepper = '2c7c6812350b0fe2826f67da1db1ee38c3506f1f207ba9520f383889cd1be966a7891f0675f3456e117d7bf8ce12ad5b0da569106106828fcd22bbaee4381f5e'
