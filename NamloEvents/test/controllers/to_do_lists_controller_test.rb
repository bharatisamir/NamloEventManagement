...
class ToDoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do_list" do
    assert_difference('ToDoList.count') do
      post to_do_lists_url, params: { to_do_list: { todo_list_description: @to_do_list.todo_list_description, todo_list_title: @to_do_list.todo_list_title, user_id: @to_do_list.user_id } }
    end
  ...
  test "should update to_do_list" do
    patch to_do_list_url(@to_do_list), params: { to_do_list: { todo_list_description: @to_do_list.todo_list_description, todo_list_title: @to_do_list.todo_list_title, user_id: @to_do_list.user_id } }
